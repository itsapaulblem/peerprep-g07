...
## Machine-Oriented Contract (Schema Summary)

### Enums
```json
{
  "Topic": ["arrays", "linked-lists", "trees", "graphs", "dynamic-programming"],
  "Difficulty": ["easy", "medium", "hard"],
...
```json
{
  "oneOf": [
    {
      "type": "object",
      "required": ["type", "topic", "difficulty", "language"],
      "properties": {
        "type": { "const": "enqueue" },
...
```json
{
  "oneOf": [
    {
      "type": "object",
      "required": ["type", "queueKey"],
      "properties": {
        "type": { "const": "queued" },
        "queueKey": { "type": "string", "pattern": "^[a-z-]+-(easy|medium|hard)-[a-z]+$" }
      }
    },
    {
      "type": "object",
      ...
      "properties": {
        ...
        "match": {
          "type": "object",
          "required": ["users", "roomId", "topic", "difficulty", "language", "createdAt"],
          "properties": {
            "users": {
              "type": "array",
              "minItems": 2,
    ...
    },
    {
      "type": "object",
      "required": ["type"],
      "properties": { "type": { "const": "cancelled" } }
    },
    {
      "type": "object",
...
### Canonical Gateway Call Example
```text
CONNECT ws://matching-service:3002/?userId=user-123
SEND    {"type":"enqueue","topic":"arrays","difficulty":"easy","language":"javascript"}
RECV    {"type":"queued","queueKey":"arrays-easy-javascript"}
RECV    {"type":"matched","match":{...}}  OR  {"type":"timeout"}
```
